...
Apex agents come equipped with a comprehensive toolkit:
...
Apex uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/apex-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub" icon="github" href="https://github.com/AwaisCh360/Office-Work">
