...
description: "Guide Apex with custom testing instructions"
---
...
```bash
apex --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
apex --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
apex --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Apex prioritize the most valuable attack paths.
</Tip>
