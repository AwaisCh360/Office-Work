---
title: "AWS Bedrock"
description: "Configure Apex with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install Apex with the bedrock extra:

```bash
pipx install "apex-agent[bedrock]"
```

## Setup

```bash
export APEX_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
