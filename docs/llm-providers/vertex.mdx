...
description: "Configure Apex with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Apex with the vertex extra:

```bash
pipx install "apex-agent[vertex]"
```

## Setup

```bash
export APEX_LLM="vertex_ai/gemini-3-pro-preview"
```
