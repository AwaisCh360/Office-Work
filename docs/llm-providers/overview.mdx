---
title: "Overview"
description: "Configure your AI model for Apex"
---

Apex uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
