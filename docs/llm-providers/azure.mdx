---
title: "Azure OpenAI"
description: "Configure Apex with OpenAI models via Azure"
---

## Setup

```bash
export APEX_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `APEX_LLM` | `azure/<your-deployment-name>` |
...
```bash
export APEX_LLM="azure/gpt-5.4-deployment"
