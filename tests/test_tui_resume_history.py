...
from apex.interface.tui.backend.live_view import TuiLiveView as GoTuiLiveView
from apex.interface.tui.live_view import TuiLiveView, _is_internal_agent_turn
...
def test_user_instruction_opens_the_transcript_when_the_root_agent_appears(
    ...
    view.upsert_agent("ab12", name="Apex", parent_id=None, status="running")
