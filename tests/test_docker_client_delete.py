"""ApexDockerSandboxClient.delete() best-effort teardown.
...
def _client_with_kill_error(exc: Exception) -> ApexDockerSandboxClient:
    """A ApexDockerSandboxClient whose containers.get(...).kill() raises ``exc``."""
    client = ApexDockerSandboxClient.__new__(ApexDockerSandboxClient)
