...
The wire protocol is declared twice — ``apex/interface/tui/backend/protocol.py``
for the backend and ``apex/interface/tui/internal/protocol/protocol.go`` for the
...
from apex.interface.tui.backend.protocol import PROTOCOL_CAPABILITIES, PROTOCOL_VERSION
