...
import (
	...
	"github.com/AwaisCh360/Office-Work/tui/internal/protocol"
)
...
func TestLongErrorDoesNotBreakTheFrame(t *testing.T) {
	...
	bootstrap := protocol.CollectionBootstrap{
		...
		Items: []json.RawMessage{rawJSON(t, protocol.Agent{ID: "a0", Name: "Apex", Status: "running"})},
	}
	...
	if !strings.Contains(ansi.Strip(model.View()), "Apex") {
