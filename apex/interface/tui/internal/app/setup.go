...
func (m Model) setupHintsView(width int) string {
	...
	left := hint("enter", "launch") + label("  ") + hint("ctrl+m", "mode") + label("  ") + hint("ctrl+s", "scope") + label("  ") + hint("ctrl+b", "budget") + label("  ") + hint("ctrl+c", "quit")
	if lipgloss.Width(left) > inner {
		left = hint("enter", "launch") + label("  ") + hint("ctrl+m", "mode") + label("  ") + hint("ctrl+c", "quit")
	}
