 ...
 *
 * The OSS apex engine (AwaisCh360/Office-Work) is the source of truth for tool names:
 * see `apex/tools/**` for definitions and `apex/interface/tui/renderers/` for
...
const CATEGORY_TOOLS: Record<ToolCategory, readonly string[]> = {
  ...
  search: ["web_search"],
  // scan_start_info / subagent_start_info are apex-app synthetic events; finish_scan is the engine's
