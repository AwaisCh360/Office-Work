...
from apex.runtime.backends import backend_supports_bind_mounts, get_backend
from apex.runtime.caido_bootstrap import bootstrap_caido
...
def _host_identity_env() -> dict[str, str]:
    ...
    return {"APEX_HOST_UID": str(os.getuid()), "APEX_HOST_GID": str(os.getgid())}
