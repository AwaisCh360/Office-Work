"""Execution loop for addressable SDK-backed Apex agents."""
...
from apex.core.hooks import (
    BudgetExceededError,
    BudgetPausedError,
    SubagentBudgetReservedError,
)
from apex.core.inputs import child_initial_input
from apex.core.sessions import (
...
from apex.llm.compaction import is_context_overflow, maybe_compact
...
if TYPE_CHECKING:
    ...
    from apex.core.agents import AgentCoordinator, Status
...
async def _append_tool_required_message(
    *,
    ...
    if interactive:
        ...
        message = (
            "Your previous response ended the autonomous Apex run without a lifecycle tool "
